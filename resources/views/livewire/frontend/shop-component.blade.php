                            ...
                            <div class="col-md-4 col-sm-6 col-12">
                                <div class="product">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <h3>
                                            <a href="{{route('product-details')}}"> TruRadix Curcumin Oral Strip Orange
                                                Mango</a>
                                        </h3>
                            ...
                            <div class="col-md-4 col-sm-6 col-12">
                                <div class="product">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <h3>
                                            <a href="{{route('product-details')}}">Goodlife Nutrition Immunity Boosting
                                                Complex
                                                Capsule</a>
                                        </h3>
                                        <div class="product-value">
                            ...
                            <div class="col-md-4 col-sm-6 col-12">
                                <div class="product">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <h3>
                                            <a href="{{route('product-details')}}">CoviFind Covid 19 Antigen Self Test
                                                Kit</a>
                                        </h3>
                                        <div class="product-value">
                                            <div class="d-flex">
                            ...
                            <div class="col-md-4 col-sm-6 col-12">
                                <div class="product">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <h3>
                                            <a href="{{route('product-details')}}">Cetaphil Sun Kids Liposomale Lotion SPF
                                                30</a>
                                        </h3>
                                        <div class="product-value">
                                            <div class="d-flex">
                            ...
                            <div class="col-md-4 col-sm-6 col-12">
                                <div class="product">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <h3>
                                            <a href="{{route('product-details')}}">Iodex Ultra Gel</a>
                                        </h3>
                                        <div class="product-value">
                                            <div class="d-flex">
                                                <small class="regular-price">MRP <del>₹250.99</del></small>
                            ...
                            <div class="col-md-4 col-sm-6 col-12">
                                <div class="product">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <h3>
                                            <a href="{{route('product-details')}}">Abbott Panbio Covid 19 Antigen Self Test
                                                Kit</a>
                                        </h3>
                                        <div class="product-value">
