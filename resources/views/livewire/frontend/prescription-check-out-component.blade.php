                            ...
                            <div>
                                <form   enctype="multipart/form-data"  wire:submit.prevent="UploadPresc">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file"  wire:model="prescription" class=" form-control" id="customFile" required>
                                        @error('prescription') <p class="text-danger">{{$message}}</p> @enderror                     
                                    </div>
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-block btn-primary">Continue <i class="fa fa-fw fa-caret-right"></i></button>
                                    </div>
                                </form>
                            </div>
