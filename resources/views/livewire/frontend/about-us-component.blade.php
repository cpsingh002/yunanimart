        ...
        <section class="py-5 py-md-8 overlay background-center text-white" data-overlay="6" data-overlay-color="dark" data-background="{{asset('assets/img/extra/page-about.jpg')}}">
            <div class="container">
                <div class="header-align text-center">
                    <h1 class="h1 mb-1">Building better teams</h1>
                    <span>An opportunity to introduce the major benefits of your product and set the scene for what's to
                        come </span>
                </div>
            </div>
        </section>
            ...
            <a href="#" wire:click.prevent="payeasybuzz">
                ...
                <div class="row">
                    <div class="col-lg-7 col-md-6">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <ul class="list list-icon mb-lg-0">
                                    <li>  Lorem ipsum
                                        dolor sit amet</li>
                                    <li> 
                                        consectetuer
                    ...
                    <div class="col-lg-5">
                        <div class="feature-box icon-left mb-3">
                        ...
                        <div class="feature-box icon-left">
                            <div class="icon-box-info mb-lg-0">
                                <h5>02. Making</h5>
                                <p class=" mb-lg-0">Lorem ipsum dolor sit amet consectetur adi pisicing elit. Id, quas?
                                    Ratione magnam
                                    pariatur consequuturn.
                                </p>
                            </div>
