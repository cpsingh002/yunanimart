         ...
         <div class="py-5">
             <div class="row g-4 align-items-center">
                 <div class="col">
                     ...
                     <h1 class="h3 m-0">All Reviews</h1>
                 </div>
                     ...
                     <table class="sa-datatables-init" data-order="[[ 1, &quot;asc&quot; ]]" data-sa-search-input="#table-search" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                         ...
                         <tbody>
                             ...
                             <tr>
                                        ...
                                        <td>@if($review->status == 1) Active  
                                        @else Deactive
                                        @endif</td>
                                        <td><a class="btn btn-rounded btn-primary" href="#" wire:click.prevent="VerifyReview({{$review->id}})">Verify</a>
                                    </td>
