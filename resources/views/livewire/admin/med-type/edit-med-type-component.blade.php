                                 ...
                                 <div class="card">
                                     <div class="card-body p-5">
                                         ...
                                         <form class="form-horizontal" enctype="multipart/form-data"
                                             wire:submit.prevent="updateMedtype">
                                             <div class="mb-5">
                                            ...
                                            <div class="mb-4">
                                                 ...
                                                 <input type="text" placeholder="Title" class="form-control"
                                                     wire:model="medtype" wire:keyup="generateSlug" />
                                                 @error('medtype') <p class="text-danger">{{$message}}</p> @enderror
                                            </div>

                                            <div class="mb-4">
                                                 <label for="form-banner/name" class="form-label">Slug</label>
                                                 <input type="text" placeholder="Slug" class="form-control"
                                                     wire:model="medtype_slug" />
                                                 @error('medtype_slug') <p class="text-danger">{{$message}}</p> @enderror
                                            </div>
                                            <div class="md-4">
